...
<?php include $inc_lang.'header.inc' ?>
        ...
        <h2 id="DE"><img src="/img/Germany32.png"  class="flagimg" alt="deutsche Flagge" /> Auswertungen für Deutschland</h2>
...
<?php include $inc_lang.'results-trth.inc' ?>
                ...
                <tbody>
                    ...
                    <?php CreateNewFullEntry( "DE-BW-TGO", "de", "Konfiguration" ); ?>

                    <?php CreateNewFullEntry( "DE-BW-VGC", "de", "Konfiguration" ); ?>
                    ...
                    <?php CreateNewFullEntry( "DE-BW-move", "de", "Konfiguration" ); ?>
                    ...
                    <?php CreateNewFullEntry( "DE-NI-GVH", "de", "Konfiguration" ); ?>

                    <?php CreateNewFullEntry( "DE-NI-NHP", "de", "Konfiguration" ); ?>
                    ...
                    <?php CreateNewFullEntry( "DE-SN-VVO", "de", "Konfiguration" ); ?>

                    <?php CreateNewFullEntry( "DE-SN-VVV", "de", "Konfiguration" ); ?>

                    <?php CreateNewFullEntry( "DE-SN-ZVON", "de", "Konfiguration" ); ?>

                    <?php CreateNewFullEntry( "DE-SN-ZVVO", "de", "Konfiguration" ); ?>
