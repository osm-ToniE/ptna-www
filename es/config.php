    ...
    <body>
      ...
      <div id="wrapper">
        ...
        <main id="main" class="results">
            ...
            <p>
                La salida de <a href="/en/index.php#messages">errores y comentarios</a> puede controlarse mediante una variedad de <a href="/en/index.php#options">opciones de análisis< / a>. <br />
