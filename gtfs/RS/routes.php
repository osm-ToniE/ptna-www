...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <h2 id="RS"><a href="index.php"><img src="/img/Serbia32.png"  class="flagimg" alt="Flag of Serbia" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Serbia</span>'; } ?></h2>
            <div class="indent">
