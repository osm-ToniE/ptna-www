...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="DK"><a href="index.php"><img src="/img/Denmark32.png"  class="flagimg" alt="Flag til Danmark" /></a> GTFS-analyser for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Danmark</span>'; } ?></h2>
            <div class="indent">
