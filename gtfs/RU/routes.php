...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="RU"><a href="index.php"><img src="/img/Russia32.png"  class="flagimg" alt="Флаг России" /></a> Анализ GTFS для <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">России</span>'; } ?></h2>
            <div class="indent">
