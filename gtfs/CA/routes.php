...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="CA"><a href="index.php"><img src="/img/Canada32.png" alt="Flag of Canada" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Canada</span>'; } ?></h2>
            <div class="indent">
