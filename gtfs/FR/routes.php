...
<?php $network  = $_GET['network']; ?>
            ...
            <h2 id="FR"><a href="index.php"><img src="/img/France32.png" alt="tricolore franciase" /></a> GTFS Analysis pour <?php if ( $network ) { echo '<span id="network">' . htmlspecialchars($network) . '</span>'; } else { echo '<span id="network">la France</span>'; } ?></h2>
            <div class="indent">
