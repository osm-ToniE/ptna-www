...
<?php include $inc_lang.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="AU"><a href="index.php"><img src="/img/France32.png" alt="tricolore franciase" /></a> GTFS Analysis pout <?php if ( $network && $route_id && $route_short_name ) { echo '<a href="routes.php?network=' .urlencode($network) . '">' . htmlspecialchars($network) . '</a> Route "' . htmlspecialchars($route_short_name) . '"'; } else { echo "la France"; } ?></h2>
            <div class="indent">
