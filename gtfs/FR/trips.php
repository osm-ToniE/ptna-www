...
<?php if ( $entries['good_matches'] > 0 ) {
          echo    "                '*' : il y a une correspondance avec le GTFS-Route-ID\n";
      }
      printf( "                <p>La recherche s'est terminée en %f secondes</p>\n", $entries['duration'] );
?>
               </div>
<?php endif; ?>
