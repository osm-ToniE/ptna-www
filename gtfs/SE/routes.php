...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="SE"><a href="index.php"><img src="/img/Sweden32.png"  class="flagimg" alt="Sveriges flagga" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Sverige</span>'; } ?></h2>
            <div class="indent">
