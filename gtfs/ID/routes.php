...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="ID"><a href="index.php"><img src="/img/Indonesia32.png"  class="flagimg" alt="Flag of Indonesiya" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Indonesiya</span>'; } ?></h2>
            <div class="indent">
