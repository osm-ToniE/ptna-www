...
<?php $duration = 0; ?>
        <main id="main" class="results">
            ...
            <h2 id="ID"><a href="index.php"><img src="/img/Indonesia32.png"  class="flagimg" alt="Flag of Indonesiya" /></a> GTFS Analysis for Indonesiya</h2>
            <div class="indent">
...
<?php include $lang_dir.'gtfs-trth.inc' ?>
                    ...
                    <tbody>
<?php
    $duration += CreateGtfsEntry( "ID-JK-Transjakarta" );
?>
                    </tbody>
                </table>
