...
?>
        <main id="main" class="results">
            ...
            <h2 id="GB"><a href="index.php"><img src="/img/GreatBritain32.png"  class="flagimg" alt="Flag of the United Kingdom" /></a> GTFS Analysis for
                    <?php if ( $feed && $shape_id ) {
                              ...
                              echo '<span id="feed">the United Kingdom</span>' . "\n";
                          }
                    ?>
                </h2>
                <div class="indent">
