...
?>
        <main id="main" class="results">
            ...
            <div class="gtfs-intro">
                ...
                <h2 id="US"><a href="index.php"><img src="/img/USA32.png"  class="flagimg" alt="Flag of the United States of Amerika" /></a> GTFS Analysis for
                    <?php if ( $feed && $shape_id ) {
                              ...
                              echo '<span id="feed">the United States of Amerika</span>' . "\n";
                          }
                    ?>
                </h2>
                <div class="indent">
