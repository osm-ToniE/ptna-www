...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="EU"><a href="index.php"><img src="/img/Europe32.png"  class="flagimg" alt="Europe" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Europe</span>'; } ?></h2>
            <div class="indent">
