...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="PL"><a href="index.php"><img src="/img/Poland32.png" alt="Flaga Polski" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Australia</span>'; } ?></h2>
            <div class="indent">
