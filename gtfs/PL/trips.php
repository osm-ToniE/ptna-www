...
<?php include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
           ...
           ?>
            ...
            <h2 id="PL"><a href="index.php"><img src="/img/Poland32.png"  class="flagimg" alt="Flaga Polski" /></a> GTFS Analysis for <?php if ( $feed && $route_id != '' && $route_short_name != '' ) { echo '<a href="routes.php?feed=' . urlencode($feed) . '&release_date=' . urlencode($release_date) . '">' . htmlspecialchars($feed_and_release) . '</a> Route "' . htmlspecialchars($route_short_name) . '"'; } else { echo "Polski"; } ?></h2>
            <div class="indent">
