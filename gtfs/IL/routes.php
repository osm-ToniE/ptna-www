...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="IL"><a href="index.php"><img src="/img/Israel32.png"  class="flagimg" alt="Flag of Israel" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Israel</span>'; } ?></h2>
            <div class="indent">
