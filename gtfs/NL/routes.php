...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="NL"><a href="index.php"><img src="/img/Netherlands32.png"  class="flagimg" alt="Vlag van Nederland" /></a> GTFS analyse voor <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Nederland</span>'; } ?></h2>
            <div class="indent">
