            ...
            <main id="main" class="results">
                ...
                <div class="indent">
                    ...
                    <div id="routes-table-buttons">
                        ...
                        <span style="white-space: nowrap"><button class="button-save" title="Select suspicious trips" onclick="SelectRoutesTableRowsIfSuspicious()">Select suspicous trips <img src="/img/Suspicious.svg" height="14" width="14" alt="Attention"></button></span>
