...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="CH"><a href="index.php"><img src="/img/Switzerland32.png"  class="flagimg" alt="Schweizerfahne" /></a> GTFS Analysen für <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">die Schweiz</span>'; } ?></h2>
            <div class="indent">
