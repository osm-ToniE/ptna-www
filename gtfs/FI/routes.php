...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="FI"><a href="index.php"><img src="/img/Finland32.png"  class="flagimg" alt="flag of Finland" /></a> GTFS Analysis for <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">Suomi / Finland</span>'; } ?></h2>
            <div class="indent">
