...
<?php   include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
            ...
            <h2 id="RO"><a href="index.php"><img src="/img/Romania32.png"  class="flagimg" alt="Steagul României" /></a> Analiza GTFS pentru <?php if ( $feed ) { echo '<span id="feed">' . htmlspecialchars($feed_and_release) . '</span>'; } else { echo '<span id="feed">România</span>'; } ?></h2>
            <div class="indent">
...
?>
                ...
                <h3 id="routes">Rute existente</h3>
                <div class="indent">
