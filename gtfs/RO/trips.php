...
<?php include $lang_dir.'header.inc' ?>
        ...
        <main id="main" class="results">
           ...
           ?>
            ...
            <h2 id="RO"><a href="index.php"><img src="/img/Romania32.png"  class="flagimg" alt="Steagul României" /></a> Analiza GTFS pentru <?php if ( $feed && $route_id != '' && $route_short_name != '' ) { echo '<a href="routes.php?feed=' . urlencode($feed) . '&release_date=' . urlencode($release_date) . '">' . htmlspecialchars($feed_and_release) . '</a> Traseu "' . htmlspecialchars($route_short_name) . '"'; } else { echo "România"; } ?></h2>
            <div class="indent">

                <h3 id="feeds">Surse GTFS disponibile</h3>
                <div class="indent">

<?php   $months_short = array( "Ian", "Feb", "Mar", "Apr", "May", "Iun", "Iul", "Aug", "Sep", "Oct", "Noi", "Dec" );
...
<?php if ( $ptna_analysis_source ): ?>
                <h3 id="ptna-data">Date de analiză PTNA pentru această rută</h3>
                <div class="indent">
...
<?php if ( $entries['good_matches'] > 0 ) {
          echo    "                '*' : există o potrivire cu GTFS-Route-ID\n";
      }
...
<?php endif; ?>
                ...
                <h3 id="routes">Variante de traseu existente</h3>
                <div class="indent">
