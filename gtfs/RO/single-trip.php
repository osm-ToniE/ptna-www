...
?>
        ...
        <main id="main" class="results">
            ...
            <div class="gtfs-intro">
                ...
                <h2 id="RO"><a href="index.php"><img src="/img/Romania32.png"  class="flagimg" alt="Steagul României" /></a> Analiza GTFS pentru <?php if ( $feed && $route_id && $route_short_name && $trip_id ) { echo '<a href="routes.php?feed=' . urlencode($feed) . '&release_date=' . urlencode($release_date) . '"><span id="feed">' . htmlspecialchars($feed_and_release) . '</span></a> <a href="trips.php?feed=' . urlencode($feed) . '&release_date=' . urlencode($release_date) .  '&route_id=' . urlencode($route_id) . '">Traseu "<span id="route_short_name">' . htmlspecialchars($route_short_name) . '</span></a>", Trip-Id = "<span id="trip_id">' . htmlspecialchars($trip_id) . '</span>"'; } else { echo '<span id="feed">România</span>'; } ?></h2>
                <div class="indent">
                    <ul>
                        <li><a href="#showonmap">Map</a></li>
                        <li><a href="#proposal">Sugestie pentru etichetarea OSM</a></li>
                ...
                <div class="indent">
                    <?php
                        ...
                        echo "                <p>\n";
                        echo "                    Vă rugăm să rețineți: Datele GTFS pot conține erori, pot indica un traseu inexact sau pot fi incomplete.\n";
                        echo "                </p>\n";
            ...
            <div class="clearing">
                ...
                <h2 id="proposal">Sugestie pentru etichetarea OSM</h2>
                <div class="indent">
                    ...
                    <table id="gtfs-single-trip">
                        <thead>
                            <tr class="gtfs-tableheaderrow">
                                <th class="gtfs-name" colspan="8">Stops</th>
