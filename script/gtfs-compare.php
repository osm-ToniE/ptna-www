...
#                echo $indent . '    <th colspan="4" class="gtfs-name"><input type="checkbox" name="type" value="d">Drop down list</th>' . "\n";
    ...
    function CreateCompareTripsTableStopsPlatforms( $feed, $feed2, $release_date, $release_date2, $trip_id, $trip_id2, $osm_relation ) {
        ...
        if ( $osm_relation == 1549761 && $trip_id == "320.T0.19-210-s24-1.1.H"  ) {
            ...
            echo $indent . '                <th class="compare-trips-right" colspan="6">Platform data of OSM route (r' . $osm_relation . ")</th>\n";
            ...
            echo $indent . '                <th class="compare-trips-right">gtfs:stop_id' . "</th>\n";
            ...
            echo $indent . '                <td>&nbsp;' . "\n";
            echo $indent . '                <td class="compare-trips-minor">654</td>' . "\n";
            echo $indent . '                <td colspan="5">&nbsp;' . "\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td>2</td>' . "\n";
            ...
            echo $indent . '                <th class="compare-trips-right" colspan="6">OSM route (r' . $osm_relation . ")</th>\n";
