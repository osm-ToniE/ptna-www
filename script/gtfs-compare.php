...
#                echo $indent . '    <th colspan="4" class="gtfs-name"><input type="checkbox" name="type" value="d">Drop down liste</th>' . "\n";
    ...
    function CreateCompareRoutesTable( $feed, $feed2, $release_date, $release_date2, $route_id, $route_id2, $osm_relation, $ptna_lang ) {
        ...
        #}
            ...
            echo $indent . '                <td align="center" style="background-color: #00ff00"><a target="_blank"  href="/gtfs/compare-trips.php?poc&feed=' . htmlspecialchars($feed) . '&release_date=' . htmlspecialchars($release_date) . '&trip_id=' . htmlspecialchars("320.T0.19-210-s24-1.1.H") . '&relation=' . htmlspecialchars("1549761") . '" title="">0S / 0P' . "</a></td>\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td align="right"  style="background-color: #cccccc" ' .
    ...
    function CreateCompareTripsTableStopsPlatforms( $feed, $feed2, $release_date, $release_date2, $trip_id, $trip_id2, $osm_relation ) {
        ...
        if ( $osm_relation == 1549761 && $trip_id == "320.T0.19-210-s24-1.1.H"  ) {
            ...
            echo $indent . '        <thead class="compare-trips-middle">' . "\n";
            echo $indent . '            <tr>' . "\n";
            ...
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <th class="compare-trips-left" >stop_id' . "</th>\n";
            ...
            echo $indent . '                <td>11.66148</td>' . "\n";
            echo $indent . '                <td>de:09184:2315:0:2</td>' . "\n";
            echo $indent . '                <td>1</td>' . "\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td colspan="5">&nbsp;' . "\n";
            echo $indent . '                <td style="text-align: center; background-color: yellow">632</td>' . "\n";
            echo $indent . '                <td>&nbsp;' . "\n";
            echo $indent . '                <td style="text-align: center; background-color: yellow">654</td>' . "\n";
            echo $indent . '                <td colspan="5">&nbsp;' . "\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td>2</td>' . "\n";
            ...
            echo $indent . '                <td>&nbsp;' . "\n";
            echo $indent . '                <td>304</td>' . "\n";
            echo $indent . '                <td colspan="5">&nbsp;' . "\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td>5</td>' . "\n";
            echo $indent . '                <td>de:09184:2247:0:1</td>' . "\n";
           ...
           echo $indent . '                 <td><img src="/img/dot_grey32.png" height="18"></td>' . "\n";
            ...
            echo $indent . '                <td>&nbsp;' . "\n";
            echo $indent . '                <td>487</td>' . "\n";
            echo $indent . '                <td colspan="5">&nbsp;' . "\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td>13</td>' . "\n";
            echo $indent . '                <td>de:09184:2302:0:2</td>' . "\n";
            ...
            echo $indent . '                <td>&nbsp;' . "\n";
            echo $indent . '                <td>1351</td>' . "\n";
            echo $indent . '                <td colspan="5">&nbsp;' . "\n";
            echo $indent . '            </tr>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <td>14</td>' . "\n";
            echo $indent . '                <td>de:09162:1010:5:5</td>' . "\n";
            ...
            echo $indent . '        <tfoot>' . "\n";
            echo $indent . '            <tr>' . "\n";
            echo $indent . '                <th style="background-color: #bbbbbb; text-align: center">14' . "</th>\n";
            echo $indent . '                <th style="background-color: #bbbbbb; text-align: center" colspan="4">GTFS trip (' . $trip_id . ")</th>\n";
            echo $indent . '                <th style="background-color: yellow;  text-align: center">&#x3A3; 6489' . "</th>\n";
            echo $indent . '                <th style="background-color: #bbbbbb; text-align: center">&nbsp;' . "</th>\n";
            echo $indent . '                <th style="background-color: yellow;  text-align: center">&#x3A3; 6521' . "</th>\n";
            ...
            echo $indent . '    </table>' . "\n";
            echo $indent . '</div>' . "\n";
        } elseif ( $osm_relation == 1549761 && $trip_id == "242.T0.19-210-s24-1.5.R" ) {
            ;
        }
        $stop_time = gettimeofday(true);
        return $stop_time - $start_time;
