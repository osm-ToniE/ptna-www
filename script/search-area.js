...
function show_osmium_getid_area( data ) {
    console.log( decodeURI(data) );
    return;
}

function show_osmium_extract_area( data ) {
    console.log( decodeURI(data) );
    return;
}

function show_overpass_api_area( query ) {
    ...
    if ( query && query !== '' ) {
        ...
        var url     = `${OSM_API_URL_PREFIX}${query}${OSM_API_URL_SUFFIX}`;
