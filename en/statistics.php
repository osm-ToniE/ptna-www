...
<?php include "header.inc" ?>
        ...
        <main id="main" class="results">
            ...
            <a href="showlogs.php?job=india-iran-la-reunion" title="Show logs for planet handling: India, Iran, La Reunion">India, Iran and La Reunion (UTC+05.03, UTC+04, UTC+03.30) @ 23:15 Munich, DE time</a> /
            ...
            <a href="showlogs.php?continent=central-america" title="Show logs for continent handling: Asia">Central America</a> /
            <a href="showlogs.php?continent=north-america"   title="Show logs for continent handling: Asia">North America</a> /
            <a href="showlogs.php?continent=south-america"   title="Show logs for continent handling: Asia">South America</a> /
